...
def main(args):
    mnist_data = MachinineDataModule(batch_size=args.batch_size, num_samples=args.num_samples)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_size', type=int, default=784, help='input size of MLP (default: 784)')
    parser.add_argument('--hidden_sizes', type=int, nargs='+', default=[128, 64], help='sizes of hidden layers (default: [128, 64])')
    parser.add_argument('--output_size', type=int, default=10, help='output size of MLP (default: 10)')
    parser.add_argument('--epochs', type=int, default=1, help='number of epochs to train (default: 1)')
    parser.add_argument('--dataset_path', type=str, default=None, help='path to the dataset cvs')
